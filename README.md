...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/cloudflare-worker-demo)
...
```
npm create cloudflare@latest -- --template=cloudflare/templates/cloudflare-worker-demo
```

A live public deployment of this template is available at [https://cloudflare-worker-demo.templates.workers.dev](https://cloudflare-worker-demo.templates.workers.dev)
